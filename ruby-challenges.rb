...
# I started to create the method before the array with the hash was defined, I couldn't understand why my method wasn't working when I would pass us_states as the argument. us_states was an undefined local variable and not in my scope since I created a method before I declared it. As always simple mistakes always hurt the most.
us_states = { northwest: ['Washington', 'Oregon', 'Idaho'], southwest: ['California', 'Arizona', 'Nevada'], notheast: ['Maine', 'New Hampshire', 'Rhode Island'] }
# Create a method called alpha_order and pass in an array as the parameter. 
def alpha_order array
  # I Used dot notation with values to lcoation the values associated with their respective keys, then flatten the array so they are not embedded arrays in the overall array. Then, add sort after we flatten so the whole array is being sorted alphabetically!
...
# "The Trek bike has two wheels and is going zero mph."
